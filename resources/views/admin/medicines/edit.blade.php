...
<div class="content-wrapper">
    <div class="content">
        ...
        <form method="POST" action="{{ route('admin.medicines.update', $medicine->id) }}" autocomplete="off"
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        placeholder="{{ __('labels.name') }}" value="{{ $medicine->name }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control @error('medicine_group_id')is-invalid @enderror"
                                        ...
                                        <option value="{{ $child->id }}"
                                            {{ $medicine->medicine_group_id ? 'selected' : '' }}>- {{ $child->name }}
                                        </option>
                                        @endforeach
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('description')is-invalid @enderror"
                                        name="description"
                                        id="textarea-description">{{ $medicine->description }}</textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="unit"
                                        ...
                                        placeholder="{{ __('labels.unit') }}" value="{{ $medicine->unit }}">
                                    <div class="invalid-feedback">
                                        {{ $errors->first('unit') }}
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="quantity" min="0"
                                        ...
                                        placeholder="{{ __('labels.quantity') }}" value="{{ $medicine->quantity }}">
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="price"
                                        ...
                                        placeholder="{{ __('labels.price') }}" value="{{ $medicine->price }}">
                                    <div class="invalid-feedback">
                                        {{ $errors->first('price') }}
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="exp" class="form-control @error('exp')is-invalid @enderror"
                                        id="input-exp" placeholder="{{ __('labels.exp') }}"
                                        value="{{ date('d/m/Y', strtotime($medicine->exp)) }}">
                                    <div class="invalid-feedback">
                                        {{ $errors->first('exp') }}
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    {{ $medicine->medicineDetail->ingredients }}
                                    </textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('objects_used')is-invalid @enderror"
                                        ...
                                        {{ $medicine->medicineDetail->objects_used }}
                                    </textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('dosage_and_usage')is-invalid @enderror"
                                        ...
                                        {{ $medicine->medicineDetail->dosage_and_usage }}
                                    </textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('preservation')is-invalid @enderror"
                                        ...
                                        {{ $medicine->medicineDetail->preservation }}
                                    </textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('careful')is-invalid @enderror" name="careful"
                                        id="textarea-careful">
                                        {{ $medicine->medicineDetail->careful }}
                                    </textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-footer pt-3 border-top text-right">
                                <button type="submit" class="btn btn-success btn-default">Cập nhật</button>
                            </div>
                        </div>
                    </div>
                </div>
